/**
 * Docs page route component (createDocsPage function)
 *
 * Creates a CompiledNode structure for documentation pages.
 * Renders header, sidebar, main content with MDX, and footer.
 *
 * @module routes/docs/[...slug]
 */
...
function createNotFoundPage(currentPath: string): CompiledElementNode {
  ...
  const sidebar = createSidebar({ currentPath, navigation: docsNavigation });
...
/**
 * Creates the Docs page as a CompiledNode
 *
 * @param params - Page params including optional slug array
 * @returns CompiledElementNode representing the docs page
 */
...
/**
 * Returns all static paths for docs pages
 *
