...
The dev server includes [Hot Module Replacement (HMR)](/docs/hmr) for instant feedback during development. When you save changes to JSON files, the browser updates automatically while preserving application state.
