    ...
    "children": [
      {
        ...
        "tag": "h1",
        "children": [
          { "kind": "text", "content": { "expr": "lit", "value": "Posts" } }
        ]
      },
      {
        "kind": "element",
        "tag": "button",
        "events": { "onClick": { "action": "loadPosts" } },
        "children": [
          { "kind": "text", "content": { "expr": "lit", "value": "Load Posts" } }
        ]
      },
      {
        "kind": "if",
        ...
        "then": {
          "kind": "text",
          "content": { "expr": "lit", "value": "Loading..." }
        }
      },
      {
        "kind": "if",
        ...
        "then": {
          ...
          "children": [
            { "kind": "text", "content": { "expr": "state", "name": "error" } }
          ]
        }
      },
      {
        "kind": "each",
        "list": { "expr": "state", "name": "posts" },
        "itemName": "post",
        "template": {
          "kind": "element",
          "tag": "article",
          "children": [
            {
              ...
              "tag": "h2",
              "children": [
                { "kind": "text", "content": { "expr": "var", "name": "post", "path": "title" } }
              ]
            },
            {
              "kind": "element",
              "tag": "p",
              "children": [
                { "kind": "text", "content": { "expr": "var", "name": "post", "path": "body" } }
              ]
            }
          ]
        }
