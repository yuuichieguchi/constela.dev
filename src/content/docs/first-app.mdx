    ...
    "children": [
      {
        ...
        "tag": "h1",
        "children": [
          { "kind": "text", "content": { "expr": "lit", "value": "Counter" } }
        ]
      },
      {
        "kind": "element",
        "tag": "p",
        "children": [
          { "kind": "text", "content": { "expr": "lit", "value": "Count: " } },
          { "kind": "text", "content": { "expr": "state", "name": "count" } }
        ]
      },
      {
        "kind": "element",
        ...
        "children": [
          {
            "kind": "element",
            "tag": "button",
            "events": { "onClick": { "action": "decrement" } },
            "children": [
          ...
          },
          {
            "kind": "element",
            "tag": "button",
            "events": { "onClick": { "action": "reset" } },
            "children": [
              { "kind": "text", "content": { "expr": "lit", "value": "Reset" } }
            ]
          },
          {
            "kind": "element",
            "tag": "button",
            "events": { "onClick": { "action": "increment" } },
            "children": [
              { "kind": "text", "content": { "expr": "lit", "value": "+" } }
            ]
          }
