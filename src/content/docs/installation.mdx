...
| `@constela/server` | Server-side rendering (optional) |
| `@constela/cli` | Command-line tools (optional) |
| `@constela/start` | Full-stack meta-framework (optional) |
...
```bash
npm install @constela/server @constela/compiler @constela/runtime
```
