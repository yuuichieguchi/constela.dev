---
title: 'API Reference (Server-side)'
description: TypeScript API for server-side usage in API routes
---
...
For DSL-based usage (recommended for most cases), see [Examples](/reference/ai/examples).
