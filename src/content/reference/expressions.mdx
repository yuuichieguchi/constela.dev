...
<PropsTable items={[
  { name: "expr", type: "\"cookie\"", required: true, description: "Expression type identifier." },
  { name: "key", type: "string", required: true, description: "Cookie name to read." },
  { name: "default", type: "string", required: true, description: "Fallback value when cookie is not set." }
]} />
...
<PropsTable items={[
  { name: "expr", type: "\"validity\"", required: true, description: "Expression type identifier." },
  { name: "ref", type: "string", required: true, description: "Name of the ref on the form element to check validity for." },
  { name: "property", type: "string", required: false, default: "\"valid\"", description: "Validity property to access. Defaults to 'valid'." }
]} />
...
<PropsTable items={[
  { name: "expr", type: "\"call\"", required: true, description: "Expression type identifier." },
  { name: "target", type: "Expression", required: true, description: "The target object (array, string, or Math/Date)." },
  { name: "method", type: "string", required: true, description: "Method name to call." },
  { name: "args", type: "Expression[]", required: false, description: "Arguments to pass to the method." }
]} />
...
<PropsTable items={[
  { name: "expr", type: "\"lambda\"", required: true, description: "Expression type identifier." },
  { name: "param", type: "string", required: true, description: "Parameter name for the current item." },
  { name: "index", type: "string", required: false, description: "Optional parameter name for the current index." },
  { name: "body", type: "Expression", required: true, description: "Expression to evaluate for each item." }
]} />
...
<PropsTable items={[
  { name: "expr", type: "\"array\"", required: true, description: "Expression type identifier." },
  { name: "elements", type: "Expression[]", required: true, description: "Array of expressions to evaluate and include in the result array." }
]} />
