...
|-----------|-------------|----------------|
| `increment` | Adds 1 to a number | No |
| `decrement` | Subtracts 1 from a number | No |
| `push` | Appends to an array | Yes |
| `pop` | Removes last element from array | No |
| `remove` | Removes matching element from array | Yes |
